...
namespace PostalDecoder.Controllers
{
    public class LocationController : ApiController
    {
        ...
        public IEnumerable<string> GetAllLocations(string zips)
        {
            List<string> result = new List<string>();

            List<String> lstReturnUSPS = AsyncHelpers.RunSync<List<string>>(() => GetLocations(zips));
            if (lstReturnUSPS != null)
            {
                foreach (string t in lstReturnUSPS)
                {
                    result.Add(t);
                }
            }
        ...
        private static async Task<List<string>> GetLocations(string zips)
        {
